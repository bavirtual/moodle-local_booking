...
$string['bookingconfirmpg'] = 'Student session selection';
...
$string['certifyconfirm'] = 'Are you sure you want to certify \'{$a}\' now? </br></br>The student will be graduated from the course and a badge will be awarded if applicable. Please confirm this action.';
...
$string['commentnoshow0'] = 'This is the student\'s first no-show, therefore they will be sent a warning and a no-show event will be recorded.<br/><br/>Proceed with processing this no-show?';
$string['commentnoshow1'] = 'This is the student\'s second no-show within 3 months, therefore they will be suspended.<br/><br/>Proceed with processing this no-show?';
$string['commentnoshow2'] = 'This is the student\'s third no-show within 3 months, therefore they will be scheduled to be unenrolled from the course.<br/><br/>Proceed with processing this no-show?';
$string['commentnoshowtitle'] = 'No-show confirmation';
...
$string['headingview'] = 'Active students progression';
$string['headingbook'] = 'Student session booking';
$string['headingconfirm'] = 'Student session confirmation';
...
$string['studentonhold'] = 'You are currently on-hold and instructors will NOT see your postings. Please post availability to be re-activated.';
...
$string['lastslotdate'] = 'Last slot posted';
...
$string['onholddate'] = 'On-hold date';
...
$string['slots'] = 'Slots';
$string['slotsactive'] = 'Total posted slots';
$string['suspenddate'] = 'Suspend date';
...
$string['competencyperf'] = 'Competency Performance';
...
$string['depdest'] = 'Dep/Dest';
$string['discussionitems'] = 'Discussion Items';
$string['discussionitemstouched'] = 'Discussion Items touched';
...
$string['gradingscale'] = '1 = best, 5 = worst. Trend arrows reflect improvement toward 1.';
$string['gradingscalelbl'] = 'Grading scale';
$string['excellent'] = 'Excellent';
$string['good'] = 'Good';
$string['signoffs'] = 'Sign-offs';
$string['standard'] = 'Standard';
$string['belowstandard'] = 'Below Standard';
...
$string['instructor_pre_brief_view'] = 'Instructor pre-brief view';
...
$string['pftime'] = 'PF time';
$string['pmtime'] = 'PM time';
$string['practicalexamreport'] = 'Practical Examination Report';
...
$string['routeitemspending'] = 'Route items pending';
$string['sector'] = 'Sector';
$string['sectors'] = 'Sectors';
$string['session'] = 'Session';
$string['sessions'] = 'Sessions';
$string['sessionsnewsttofirst'] = 'Sessions (newest first)';
$string['skill'] = 'Skill';
$string['stage'] = 'Stage';
$string['student_report_summary'] = 'Student Report Summary';
$string['student_summary'] = 'Student Summary';
$string['theoryexamreport'] = 'Theory Examination Report';
...
$string['emailnoshow1html'] = '<font face="sans-serif"><p><a href=\'{$a->courseurl}\'>{$a->coursename}</a> -> <a href=\'{$a->assignurl}\'>Assignment</a> ->
    ...
    <p>Please consider this as your warning and do note that repeated incidents will result in suspension and unenrollment from the course.</p><hr />';
...
$string['emailnoshow2html'] = '<font face="sans-serif"><p><a href=\'{$a->courseurl}\'>{$a->coursename}</a> -> <a href=\'{$a->assignurl}\'>Assignment</a> ->
    ...
    <p>Please note that this will be the final warning and missing another instructor-led session will result in your unenrolment from the {$a->coursename} course.</p><hr />';
...
$string['emailnoshow3html'] = '<font face="sans-serif"><p><a href=\'{$a->courseurl}\'>{$a->coursename}</a> -> <a href=\'{$a->assignurl}\'>Assignment</a> ->
    {$a->exercise}</p><hr /><p>You have missed an instructor-led session on {$a->sessiondate} with your instructor {$a->instructorname} for exercise \'{$a->exercise}\'.</p>
    <p>This marks the third time you miss an instructor-led session in a {$a->noshowperiod}-day period. Therefore, you will be unenrolled from the {$a->coursename} in accordance with the {$a->coursename} course policy.</p><hr />';
...
$string['emailnoshowinst1html'] = '<font face="sans-serif"><p><a href=\'{$a->courseurl}\'>{$a->coursename}</a> -> <a href=\'{$a->assignurl}\'>Assignment</a> ->
    ...
    <p>The student was issued an automatic warning and was notified that repeated incidents will result in suspension and unenrollment from the course.</p><hr />';
...
$string['emailnoshowinst2html'] = '<font face="sans-serif"><p><a href=\'{$a->courseurl}\'>{$a->coursename}</a> -> <a href=\'{$a->assignurl}\'>Assignment</a> ->
    ...
    <p>{$a->studentname} was notified that this will be a final warning and missing another instructor-led session will result in unenrolment from the {$a->coursename} course.</p><hr />';
...
$string['emailnoshowinst3html'] = '<font face="sans-serif"><p><a href=\'{$a->courseurl}\'>{$a->coursename}</a> -> <a href=\'{$a->assignurl}\'>Assignment</a> ->
    ...
    <p>{$a->studentname} was notified of being scheduled to be unenroled from  the {$a->coursename} course.</p><hr />';
...
$string['emailnoshowreinstatementhtml'] = '<font face="sans-serif"><p><a href=\'{$a->courseurl}\'>{$a->coursename}</a> -> <a href=\'{$a->assignurl}\'>Assignment</a> ->
    {$a->exercise}</p><hr /><p>Your suspension period has ended and you have been reinstated to active status.  Make sure to complete pending lesson modules, post availability slots, and please do your utmost best to avoid missing future instructor-led sessions.</p><hr />';
...
$string['emailinactivewarningmsg'] = 'Since your last booking on \'{$a->lastbookeddate}\' you have not posted availability and/or completed the next lesson.  Please post availability slots
...
$string['emailinactivewarninghtml'] = '<font face="sans-serif"><p><a href=\'{$a->courseurl}\'>{$a->coursename}</a> -> <a href=\'{$a->assignurl}\'>Assignment</a></p><hr />
    <p>Since your last booking on <strong>\'{$a->lastbookeddate}\'</strong> you have not posted availability and/or completed the next lesson.  Please post an availability slots
    and/or complete the next lesson to avoid being automatically placed on-hold on <strong>\'{$a->onholddate}\'</strong>.</p><p>You can post availability slot for
...
$string['emailonholdwarningmsg'] = 'Please post availability slots to avoid being automatically placed on-hold on \'{$a->onholddate}\'. You can post an availability slot for
    the \'{$a->coursename}\' from the following link: {$a->slotsurl}';
$string['emailonholdwarninghtml'] = '<font face="sans-serif"><p><a href=\'{$a->courseurl}\'>{$a->coursename}</a> -> <a href=\'{$a->assignurl}\'>Assignment</a></p><hr />
    <p>Please post availability slots to avoid being automatically placed on-hold on <strong>\'{$a->onholddate}\'</strong>.</p><p>You can post an availability slot for
    the \'{$a->coursename}\' course <a href="{$a->slotsurl}">here</a>.</p><hr />';

// email to student: on-hold notification
$string['emailonholdnotify'] = '{$a->coursename}: Student placed on-hold';
$string['emailonholdnotifymsg'] = 'Due to inactivity since \'{$a->lastactivitydate}\', you have been placed on-hold. Please post availability slots if you are still interested in resuming the \'{$a->coursename}\' course work.';
$string['emailonholdnotifyhtml'] = '<font face="sans-serif"><p><a href=\'{$a->courseurl}\'>{$a->coursename}</a> -> <a href=\'{$a->assignurl}\'>Assignment</a></p><hr />
    <p>Due to inactivity since <strong>\'{$a->lastactivitydate}\'</strong>, you have been placed on-hold. Please post availability slots if you are
...
$string['emailonholdinstnotifymsg'] = 'Due to inactivity since last posting on \'{$a->lastactivitydate}\', {$a->studentname} has been placed on-hold.';
$string['emailonholdinstnotifyhtml'] = '<font face="sans-serif"><p><a href=\'{$a->courseurl}\'>{$a->coursename}</a> -> <a href=\'{$a->assignurl}\'>Assignment</a></p><hr />
    <p>Due to inactivity since last posting on <strong>\'{$a->lastactivitydate}\'</strong>, {$a->studentname} has been placed on-hold.</p>
...
$string['emailsuspendnotifymsg'] = 'Please note that you have been suspended from the \'{$a->coursename}\' course due to session booking inactivity since \'{$a->lastactivitydate}\'.  Please contact your instructor if you are still interested in being enrolled in this course.';
$string['emailsuspendnotifyhtml'] = '<font face="sans-serif"><p><a href=\'{$a->courseurl}\'>{$a->coursename}</a> -> <a href=\'{$a->assignurl}\'>Assignment</a></p><hr />
    <p>Please note you have been suspended from the \'{$a->coursename}\' course due to session booking inactivity since <strong>\'{$a->lastactivitydate}\'</strong>.</p>
    <p>Please contact your instructor if you are still interested in being enrolled in this course.</p><hr />';
$string['emailsuspendinstnotifymsg'] = 'Please note that {$a->studentname} has been suspended from the \'{$a->coursename}\' course due to session booking inactivity since \'{$a->lastactivitydate}\'.';
$string['emailsuspendinstnotifyhtml'] = '<font face="sans-serif"><p><a href=\'{$a->courseurl}\'>{$a->coursename}</a> -> <a href=\'{$a->assignurl}\'>Assignment</a></p><hr />
    <p>Please note {$a->studentname} has been suspended from the \'{$a->coursename}\' course due to session booking inactivity since <strong>\'{$a->lastactivitydate}\'</strong>.</p><hr />';
...
// email html signature and footer
$string['emailsignature'] = '<div class="mt-5"><font face="sans-serif"><p>{$a->atoname} Training staff</p>{$a->atologo}</div>';
...
$string['gradmsgbodydesc'] = 'message body for the congratulatory notification of graduating students sent to course participants. Leave blank to prevent notifications from being sent.
    For more details refer to <a href="https://docs.moodle.org/405/en/Session_Booking#Skillset_evaluation_%26_graduation" target="_blank" rel="noopener noreferrer">Skillset evaluation & graduation</a>';
...
$string['configsjsondesc'] = 'custom configuration to access external data and other hidden features in JSON format (<a href="https://docs.moodle.org/405/en/Session_Booking#Advanced_configurations" target="_blank" rel="noopener noreferrer">Advanced configurations</a>)';
...
$string['errorinvalidaircraft'] = 'Aircraft may not be empty! Please make sure the PIREP ICAO matches that of the Training aircraft ICAO in the Session Booking section of the course Settings.';
