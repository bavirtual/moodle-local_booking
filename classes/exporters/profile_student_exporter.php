...
class profile_student_exporter extends exporter {
    ...
    protected function get_other_values(renderer_base $output) {
        ...
        $return = [
            ...
            'waitrestrictionenabled'   => $this->subscriber->get_student_posting_wait_days_restriction() != 0,
            'postingwait'              => $this->subscriber->get_student_posting_wait_days_restriction(),
            ...
            'sessions'                 => dashboard_student_exporter::get_sessions($output, $this->subscriber, $this->student, $this->related),
