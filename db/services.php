...
$functions = array(
    ...
    'local_booking_set_user_preferences' => array(
        'classname' => '\local_booking\external\set_user_preferences',
        'classpath' => 'local/booking/external/set_user_preferences.php',
        'methodname' => 'execute',
